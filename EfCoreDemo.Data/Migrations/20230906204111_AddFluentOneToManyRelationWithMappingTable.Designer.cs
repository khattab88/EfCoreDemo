...
namespace EfCoreDemo.Data.Migrations
{
    ...
    [Migration("20230906204111_AddFluentOneToManyRelationWithMappingTable")]
    partial class AddFluentOneToManyRelationWithMappingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.AuthorBookRelationConfiguration", b =>
                {
                    b.Property<int>("AuthorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.AuthorConfiguration", b =>
                {
                    b.Property<int>("Author_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.BookConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.BookDetailConfiguration", b =>
                {
                    b.Property<int>("BookDetail_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.PublisherConfiguration", b =>
                {
                    b.Property<int>("Publisher_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.AuthorBookRelationConfiguration", b =>
                {
                    b.HasOne("EfCoreDemo.Model.EntityConfigurations.AuthorConfiguration", "Author")
                        .WithMany("AuthorsBooks")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EfCoreDemo.Model.EntityConfigurations.BookConfiguration", "Book")
                        .WithMany("AuthorsBooks")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.BookConfiguration", b =>
                {
                    b.HasOne("EfCoreDemo.Model.EntityConfigurations.PublisherConfiguration", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EfCoreDemo.Model.EntityConfigurations.BookDetailConfiguration", b =>
                {
                    b.HasOne("EfCoreDemo.Model.EntityConfigurations.BookConfiguration", "Book")
                        .WithOne("BookDetail")
                        .HasForeignKey("EfCoreDemo.Model.EntityConfigurations.BookDetailConfiguration", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
